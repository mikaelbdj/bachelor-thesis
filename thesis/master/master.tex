...
\title{	
  ...
  \huge Symbolic Algorithms for Computing Strongly Connected Components \\[0.5cm] % The assignment main title
  \large Symbolske algoritmer for at beregne strongly connected components \\ % The assignment sub title
