...
\title{	
  ...
  \huge Symbolic Decomposition \\ of Strongly Connected Components \\[0.5cm] % The assignment main title
  \large Symbolske Algoritmer til beregning af Stærke Sammenhængskomponenter \\ % The assignment sub title
