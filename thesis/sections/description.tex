...
Here, we analyze the complexity of the two algorithms. We state the results in Theorems \ref{lockstep} and \ref{linear}. For both of these proofs we charge each step to a node. We further strengthen the complexity of Linear and Lockstep in Theorem \ref{magic}.
