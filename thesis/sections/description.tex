...
The skelForward algorithm is a helper method, which computes the forward set of the given graph and the skeleton of this set. This equivalently gives us the spine-set of the given graph.
